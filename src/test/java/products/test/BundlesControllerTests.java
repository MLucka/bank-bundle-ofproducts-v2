...
public class BundlesControllerTests {
	...
	public void getBundle() throws Exception {
		this.mockMvc.perform(get("/bundle-json/1")).andDo(print())
	...
	public void addProductToBundle() throws Exception {
		this.mockMvc.perform(get("/add-product-to-bundle-json").param("bundleId","2").param("productId", "1"))
	...
	public void removeProductFromBundle() throws Exception {
		this.mockMvc.perform(get("/remove-product-from-bundle").param("bundleId","3").param("productId", "1"))
